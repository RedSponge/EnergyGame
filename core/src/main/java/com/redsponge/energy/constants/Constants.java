package com.redsponge.energy.constants;
...
public class Constants {
    ...
    public static final float HEAT_THRESHOLD = 10;
    public static final float LIGHT_THRESHOLD = 50;
    public static final float ELECTRIC_THRESHOLD = 90;
